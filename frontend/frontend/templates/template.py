...
def menu_button() -> rx.Component:
    ...
    return rx.box(
        rx.menu(
            rx.menu_button(rx.icon(tag="hamburger", size="4em", color=styles.text_color)),
            rx.menu_list(
                *[
                    rx.menu_item(rx.link(page["title"], href=page["route"], width="100%"))
    ...
    def decorator(page_content: Callable[[], rx.Component]) -> rx.Component:
        ...
        def templated_page():
            return rx.hstack(
                sidebar(),
                rx.box(
                    rx.box(page_content(), **styles.template_content_style),
